...
| `seo` | `seo_*` | Connector-backed search-console reads (Bing Webmaster Tools) plus URL submission. Admin-only — the one connector domain with no self-service half. |
