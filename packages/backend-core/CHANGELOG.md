...
- 72209ca: Refuse a self-service booking write when the message asking for it explicitly failed DMARC, and
...
- 8ebf90e: Let a signed-in widget user look up and manage their own orders and bookings by signing their
...
- cc68c99: Judge alert-notification due-ness by the database clock, not the app server's.
...
- 26413c0: Treat a DMARC result that is neither `pass` nor `fail` as unknown, not as a failure.
...
- Updated dependencies [72209ca]
- Updated dependencies [8ebf90e]
  - @getmunin/core@5.36.0
  - @getmunin/agent-runtime@5.36.0
  - @getmunin/mcp-toolkit@5.36.0
  - @getmunin/db@5.36.0
  - @getmunin/emails@5.36.0
  - @getmunin/inspector-app@5.36.0
  - @getmunin/types@5.36.0

## 5.35.0

### Minor Changes

- c351bfa: Rename the two `revise` tools to `update`, and say in the KB and CMS update tools that a
  ...
  waiting in the review queue — a candidate _is_ a document row and a draft _is_ an entry,
...
- @getmunin/inspector-app@5.35.0
  - @getmunin/agent-runtime@5.35.0
  - @getmunin/core@5.35.0
  - @getmunin/db@5.35.0
  - @getmunin/emails@5.35.0
  - @getmunin/mcp-toolkit@5.35.0
...
- 4bab452: Point Slack links at the item the card is about, in the org it belongs to
...
- dc54f0a: Social posts can carry a picture or a video, and can put their link in the first comment.
...
- Updated dependencies [4bab452]
- Updated dependencies [dc54f0a]
  - @getmunin/types@5.31.0
  - @getmunin/core@5.31.0
  - @getmunin/db@5.31.0
  - @getmunin/inspector-app@5.31.0
  - @getmunin/agent-runtime@5.31.0
  - @getmunin/mcp-toolkit@5.31.0
  - @getmunin/emails@5.31.0
...
- fa3e72e: Show every requested scope on the OAuth consent screen.
...
- d6fa084: Guard that every `@McpTool` scope is one an OAuth client can actually be granted.
...
- Updated dependencies [fa3e72e]
  ...
  - @getmunin/inspector-app@5.30.0
  - @getmunin/agent-runtime@5.30.0
  - @getmunin/core@5.30.0
  - @getmunin/db@5.30.0
  - @getmunin/mcp-toolkit@5.30.0
  - @getmunin/emails@5.30.0
...
- cb89e7f: Add `conv_redact_existing_messages` to apply a redaction policy to history.
...
- efc2d61: Deny `/mcp` to org roles that never earned the admin audience, instead of quietly
...
- cb89e7f: Document national ID redaction as a skill, so an agent can run the whole decision with an operator: read the current policy, pick detectors and a policy, then optionally clean up history. Carries the three limits worth saying out loud — attachments, copies already delivered, and outbound text staff write themselves.
- c7c43da: Extract the outbound OAuth grant machinery out of the connectors trunk.

  Munin plays two OAuth roles that share a name and nothing else. `src/oauth/` is
  Munin _as_ an authorization server — MCP clients register there and get tokens.
  The code moved here is the other direction: grants Munin _holds_ on someone
...
- Updated dependencies [9ef22f0]
  ...
  - @getmunin/emails@5.28.0
  - @getmunin/db@5.28.0
  - @getmunin/core@5.28.0
  - @getmunin/types@5.28.0
  - @getmunin/inspector-app@5.28.0
  - @getmunin/mcp-toolkit@5.28.0
...
- Updated dependencies [2bd3138]
  - @getmunin/db@5.25.1
  - @getmunin/core@5.25.1
  - @getmunin/agent-runtime@5.25.1
  - @getmunin/mcp-toolkit@5.25.1
  - @getmunin/emails@5.25.1
  - @getmunin/inspector-app@5.25.1
  - @getmunin/types@5.25.1
...
- c73c424: File away mail from an address that takes no replies
  ...
  A mailbox deleted at the far end answers with an ordinary email, not a bounce: `noreply.autoresponder.no@contoso.test` writing "the email address you have tried to reach does not exist within our company anymore". It carries no `Auto-Submitted`, no auto-reply subject and no delivery-status report, so nothing suppressed it — it opened a conversation, raised the attention flag, and the agent drafted a courteous reply to an address that by construction discards it.
...
- f24b8a4: Stop reading a Microsoft 365 out-of-office as a bounce, and close the conversations machine mail opens
...
- Updated dependencies [f24b8a4]
  - @getmunin/db@5.23.2
  - @getmunin/core@5.23.2
  - @getmunin/agent-runtime@5.23.2
  - @getmunin/mcp-toolkit@5.23.2
  - @getmunin/emails@5.23.2
  - @getmunin/inspector-app@5.23.2
...
- 7def0de: Stop reading an Exchange forwarding hop as an auto-reply.
  ...
  `X-Auto-Response-Suppress` is an instruction to the _recipient_ not to send OOF or DSNs
...
- Updated dependencies [7def0de]
  - @getmunin/db@5.23.1
  - @getmunin/core@5.23.1
  - @getmunin/agent-runtime@5.23.1
  - @getmunin/mcp-toolkit@5.23.1
  - @getmunin/emails@5.23.1
  - @getmunin/inspector-app@5.23.1
...
- @getmunin/inspector-app@5.22.0
  - @getmunin/agent-runtime@5.22.0
  - @getmunin/core@5.22.0
  - @getmunin/db@5.22.0
  - @getmunin/emails@5.22.0
  - @getmunin/mcp-toolkit@5.22.0
...
- @getmunin/inspector-app@5.20.0
  - @getmunin/agent-runtime@5.20.0
  - @getmunin/core@5.20.0
  - @getmunin/db@5.20.0
  - @getmunin/emails@5.20.0
  - @getmunin/mcp-toolkit@5.20.0
...
- f46a162: Auth rate limiting can bucket per client IP behind a multi-hop reverse proxy.
  ...
  Two properties worth knowing before choosing a value. Trusting the range your platform's hops live in stays spoof-proof, because a platform inserts the real client address _after_ everything the caller sent and before its own hops — so entries a caller prepends, even ones inside the trusted range, sit to the left of the client and are never reached. And only name a header in `MUNIN_AUTH_IP_HEADERS` that your proxy _overwrites_: `x-real-ip`, `x-client-ip` and `Forwarded` are commonly passed through untouched, and trusting one of those removes the rate limit rather than fixing it.

### Patch Changes

- @getmunin/agent-runtime@5.19.0
  - @getmunin/core@5.19.0
  - @getmunin/db@5.19.0
  - @getmunin/emails@5.19.0
  - @getmunin/inspector-app@5.19.0
  - @getmunin/mcp-toolkit@5.19.0
...
- @getmunin/inspector-app@5.18.0
  - @getmunin/agent-runtime@5.18.0
  - @getmunin/core@5.18.0
  - @getmunin/db@5.18.0
  - @getmunin/emails@5.18.0
  - @getmunin/mcp-toolkit@5.18.0
...
- @getmunin/inspector-app@5.17.0
  - @getmunin/agent-runtime@5.17.0
  - @getmunin/core@5.17.0
  - @getmunin/db@5.17.0
  - @getmunin/emails@5.17.0
  - @getmunin/mcp-toolkit@5.17.0
...
- 12fe29d: Strip quoted history from inbound email replies that Gmail formats in a Nordic locale.
  ...
  the sender's client placed their signature _below_ the quote rather than above it.
...
- a990278: A KB document's canonical URL is now a field, `sourceUrl`, instead of a tag only the website importer could read.
...
- 36b5a46: cms_update_collection can now toggle `localized`, so a collection created without it is no longer a dead end for translation.
...
- Updated dependencies [a990278]
  - @getmunin/core@5.13.0
  - @getmunin/db@5.13.0
  - @getmunin/agent-runtime@5.13.0
  - @getmunin/mcp-toolkit@5.13.0
  - @getmunin/types@5.13.0
  - @getmunin/inspector-app@5.13.0
  - @getmunin/emails@5.13.0
...
- 26364fd: `settings.liveUrl` now accepts a per-locale map, not just one template.
...
- adf6c2b: Validate `source` and `readDepth` on analytics import instead of letting Postgres reject them.
...
- ca3c846: Refuse ambiguous legacy identity hashes on `/v1/a/identify` and log a deprecation warning for the rest.
...
- Updated dependencies [8ebf92a]
  - @getmunin/agent-runtime@5.11.0
...
- @getmunin/mcp-toolkit@5.6.0
- @getmunin/inspector-app@5.6.0
- @getmunin/agent-runtime@5.6.0
- @getmunin/emails@5.6.0
...
- Updated dependencies [67ba421]
  - @getmunin/core@5.5.0
  - @getmunin/inspector-app@5.5.0
  - @getmunin/agent-runtime@5.5.0
  - @getmunin/mcp-toolkit@5.5.0
  - @getmunin/db@5.5.0
  - @getmunin/types@5.5.0
  - @getmunin/emails@5.5.0
...
- Updated dependencies [e05b1f4]
  - @getmunin/core@5.4.0
  - @getmunin/agent-runtime@5.4.0
  - @getmunin/mcp-toolkit@5.4.0
  - @getmunin/db@5.4.0
  - @getmunin/types@5.4.0
  - @getmunin/inspector-app@5.4.0
  - @getmunin/emails@5.4.0
...
- Updated dependencies [39d2c42]
  - @getmunin/core@5.2.0
  - @getmunin/agent-runtime@5.2.0
  - @getmunin/mcp-toolkit@5.2.0
  - @getmunin/db@5.2.0
  - @getmunin/types@5.2.0
  - @getmunin/inspector-app@5.2.0
  - @getmunin/emails@5.2.0

## 5.1.0

### Minor Changes

- 7aea5d6: CMS delivery list responses now carry the `_locales` sidecar
...
- Updated dependencies [be67821]
  ...
  - @getmunin/core@5.1.0
  - @getmunin/agent-runtime@5.1.0
  - @getmunin/db@5.1.0
  - @getmunin/inspector-app@5.1.0
  - @getmunin/mcp-toolkit@5.1.0
  - @getmunin/emails@5.1.0
...
- 30ad9aa: Treat anonymous and phone-derived identities as provisional when resolving `identify`
  ...
  - @getmunin/mcp-toolkit@5.0.1
  - @getmunin/inspector-app@5.0.1
  - @getmunin/agent-runtime@5.0.1
  - @getmunin/emails@5.0.1
