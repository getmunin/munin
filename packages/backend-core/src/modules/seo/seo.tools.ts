...
export class SeoAdminTools {
  ...
  @McpTool({
    ...
    description:
      'Fetch what the search engine knows about one URL on a verified property: whether it is indexed, the HTTP status seen at last crawl, when it was last crawled and first discovered, and how many inbound anchors point at it. Returns not-found when the engine holds no record for the URL.',
    audiences: ['admin'],
    scopes: ['seo:read'],
