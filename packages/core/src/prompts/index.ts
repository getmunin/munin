...
import {
  CHANNEL_WHATSAPP_SLUG,
  CHANNEL_WHATSAPP_TITLE,
  DEFAULT_CHANNEL_WHATSAPP_PROMPT,
} from './channel-whatsapp.ts';
import {
...
export const SEEDABLE_PROMPTS: readonly SeedablePrompt[] = [
  ...
  {
    slug: CHANNEL_WHATSAPP_SLUG,
    title: CHANNEL_WHATSAPP_TITLE,
    body: DEFAULT_CHANNEL_WHATSAPP_PROMPT,
  },
  {
