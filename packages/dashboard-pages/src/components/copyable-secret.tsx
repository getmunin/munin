  ...
  return (
    <div className="space-y-2">
      ...
      <div className="flex items-center gap-2">
        <code className="flex-1 truncate border border-rule-soft dark:border-rule-on-dark bg-paper dark:bg-card px-3 py-2 font-mono text-sm text-ink dark:text-foreground">
          {value}
        </code>
