  ...
  return (
    <section className="flex min-h-0 flex-col bg-paper-deep dark:bg-secondary">
      <div ref={scrollAreaRef} className="flex min-h-0 flex-1 flex-col max-md:overflow-y-auto">
        <header className="shrink-0 border-b border-ink bg-paper px-5 pb-4 pt-5 max-md:hidden md:min-h-[146px] md:px-7 md:pt-6 dark:border-rule-on-dark dark:bg-background">
      ...
      <footer className="shrink-0 border-t border-ink bg-paper dark:border-rule-on-dark dark:bg-background">
        ...
        <div className="flex shrink-0 items-center gap-5 border-b border-rule-soft px-5 dark:border-rule-on-dark">
          <button
            type="button"
            ...
            <div className="flex flex-col gap-2.5 p-4 max-md:min-h-0 max-md:flex-1 md:px-5">
              ...
              <div className="flex shrink-0 flex-col flex-wrap items-stretch gap-2 md:flex-row md:items-center">
                ...
                <button
                  ...
                  disabled={controller.pending}
                  className="font-mono text-[9px] uppercase tracking-meta text-ink-soft transition-colors duration-fast hover:text-cobalt max-md:mt-1.5 max-md:py-1 md:ml-auto dark:text-foreground/70"
                >
                  {t('closeNoReply')}
                </button>
              </div>
