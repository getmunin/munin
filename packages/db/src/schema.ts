...
export const convTopics = pgTable(
  'conv_topics',
  {
    ...
    agentMode: varchar('agent_mode', { length: 16 }).default('draft_only'),
    autoPromotedAt: timestamp('auto_promoted_at', { withTimezone: true }),
    promoteThresholdPct: integer('promote_threshold_pct').notNull().default(90),
    createdAt,
    updatedAt,
  },
  (t) => ({
...
export const socialPostDrafts = pgTable(
  'social_post_drafts',
  {
    ...
    linkPlacement: varchar('link_placement', { length: 8 }).notNull().default('body'),
    linkCommentText: text('link_comment_text'),
    ...
    commentError: text('comment_error'),
    dismissReason: text('dismiss_reason'),
    lastError: text('last_error'),
    createdAt,
    updatedAt,
