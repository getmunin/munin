...
const pillVariants = cva(
  "inline-flex items-center gap-1.5 px-1.5 py-[3px] font-mono text-[9px] uppercase tracking-eyebrow font-medium border whitespace-nowrap before:content-[''] before:size-[5px] before:rounded-full before:bg-current",
  {
    variants: {
      tone: {
